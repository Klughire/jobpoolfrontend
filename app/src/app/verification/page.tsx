        ...
        <CardContent>
          <div className="flex flex-col gap-6 md:flex-row">
            ...
            <div className="w-full md:w-2/3">
              ...
              {currentStep === 4 && <VerificationComplete verificationStatus={verificationStatus} />}
            </div>
          </div>
        </CardContent>
        <CardFooter className="flex justify-between">
          <Button variant="outline" onClick={handleBack} disabled={currentStep === 0 || currentStep === totalSteps - 1}>
            Back
          </Button>
