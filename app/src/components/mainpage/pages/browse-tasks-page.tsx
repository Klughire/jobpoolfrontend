                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                          <div className="md:col-span-2 p-6">
                            <div className="flex justify-between items-start mb-3">
                              ...
                              >
                                {job.status === false ? "Available" : "Unavailable"}
                              </Badge>
                            </div>
                          ...
                          <div className="bg-slate-50 p-6 flex flex-col justify-between">
                            <div className="flex items-center mb-4">
                              {/* <Avatar className="h-10 w-10 mr-3">
                                <AvatarImage src={job.job_images?.urls[0]|| "images/images/placeholder.svg"} alt={job.posted_by} />

                                <AvatarFallback>
                                  {job.posted_by.charAt(0)}
                                </AvatarFallback>
                              </Avatar> */}
                              ...
                              <div>
                                ...
                                {/* <div className="flex items-center text-sm text-gray-500">
                                  ...
                                  {job.description} • {job.description} tasks
                                </div> */}
                              </div>
                            </div>
